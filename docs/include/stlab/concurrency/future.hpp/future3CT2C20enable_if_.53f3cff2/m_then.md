...
hyde:
  ...
  overloads:
    "template <class E, class F>\nauto then(E &&, F &&) &&":
      ...
      inline:
        description:
          - Returns a future that completes with the result of `f` on `executor` applied to this future's value. Rvalue overload; consumes `*this`.
      return: __OPTIONAL__
    ...
    "template <class F>\nauto then(F &&) &&":
      ...
      inline:
        description:
          - Returns a future that completes with the result of `f` applied to this future's value (default executor). Rvalue overload; consumes `*this`.
      return: __OPTIONAL__
